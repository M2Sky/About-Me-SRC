...
(async () => {
    ...
    if (!storageData.placeid) storageData.placeid = 124608841265797
    rsaver_placeid = 124608841265797
            ...
            clone.on("click", (e) => {
                ...
                //if (confirmButton.text() == "Buy Now") {
                    ...
                    makePurchase(productID, savedRobux, type)
                        // Ignore this bug pooki~ It doesn't affect anything so I am not going to fix it :3
                        .then((resp) => {
                            console.log(resp)
                            // if (savedRobux !== 0) {
                            //     notification("Saved robux!" ,"You saved " + savedRobux + " robux!")
                            //     console.log("sent!")
